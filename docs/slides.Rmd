...
* Solo il 16 per cento ha dato la risposta esatta

* La maggioranza (45%) ha ipotizzato che fosse il 50 per cento
...
* Solo il 2.5 per cento ha dato la risposta esatta

* La maggioranza (70.4%) ha ipotizzato che tutte e tre le specie fossero oggi in pericolo ancora più grave
...
```{r, echo=FALSE, fig.align = 'center', out.width = '50%', out.height = '50%'}
knitr::include_graphics("images/kahnemantversky.jpg")
```

Circa quarant'anni or sono gli psicologi Daniel Kahneman e Amos Tversky hanno dimostrato come la mente umana tenda a cadere in errore quando si trova costretta a scegliere in situazioni di incertezza
...
comportamentale**, e la loro teoria della mente è stata premiata con il Nobel vinto da Kahneman nel 2002

---

# Prezzo medio automobile tedesca

* Secondo te, il prezzo medio di un’automobile tedesca è più o meno di **100.000/20.000** EUR (a seconda della versione del questionario)

* Secondo te, a quanto ammonta il prezzo medio di un’automobile tedesca?
...
L'euristica dell’ancoraggio descrive la comune tendenza umana a fare troppo affidamento sulle prime informazioni che si trovano ("*anchor*, ancora") quando si cerca di prendere una decisione
...
knitr::include_graphics("images/Gandhi.jpg")
```

.center[2 Ottobre 1869 - 30 Gennaio 1948 (78 anni)]

* Gandhi aveva più o meno di **114/35** anni quando morì? 
...
* Scrivi le ultime due cifre del tuo numero di telefono (cellulare)

* La percentuale delle nazioni africane che appartengono all’ONU è maggiore del numero che hai appena scritto (le ultime due cifre del tuo cellulare)?

* Qual è la tua ipotesi sulla percentuale di nazioni africane nell’ONU?

---

```{r}
cifrecut = cut(as.numeric(dati$cifre),breaks = seq(0,100,10))
plot(ONU ~ cifrecut, dati)
```
...
https://aldosolari.github.io/PLS/